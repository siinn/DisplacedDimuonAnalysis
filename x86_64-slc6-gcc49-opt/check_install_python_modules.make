...
#cmt_local_tagfile_check_install_python_modules = $(DisplacedDimuonAnalysis_tag)_check_install_python_modules.make
...
#cmt_local_tagfile_check_install_python_modules = $(DisplacedDimuonAnalysis_tag).make
...
#cmt_final_setup_check_install_python_modules = $(bin)DisplacedDimuonAnalysis_check_install_python_modulessetup.make
...
#cmt_final_setup_check_install_python_modules = $(bin)DisplacedDimuonAnalysissetup.make
cmt_local_check_install_python_modules_makefile = $(bin)check_install_python_modules.make
...
$(check_install_python_modulesactionstamp) ::
	$(silent) /cvmfs/atlas.cern.ch/repo/sw/software/AthAnalysisBase/x86_64-slc6-gcc49-opt/2.4.18/AthAnalysisBase/2.4.18/External/ExternalPolicy/cmt/atlas_check_installations.sh -files=' -s=../python *.py ' -installdir=/n/atlas05/userdata/sche/2.4.18.DV_Analysis/InstallArea/python/DisplacedDimuonAnalysis -level=
