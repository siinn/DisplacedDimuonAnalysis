...
if True:
    ...
    histograms.append(f_data.Get('SecondaryVertex/m_dv_cutflow'))
    histograms.append(f_m250t100.Get('SecondaryVertex/m_dv_cutflow'))
    histograms.append(f_m1000t100.Get('SecondaryVertex/m_dv_cutflow'))
...
for p in range(len(parameters)):
    ...
    histograms[1].SetLineColor(color_m1000t100) 
...
for p in range(len(parameters)):
    ...
    # initialize legend
    legend = TLegend(0.30,0.80,0.75,0.93)
...
for p in range(len(parameters)):
    ...
    # initialize legend
    legend = TLegend(0.35,0.83,0.82,0.93)
    ...
    histograms.append(f_m250t500.Get('SecondaryVertex/cosmicVeto/signal_muon_%s' % parameters[p] ))
