...
for p in range(len(parameters)):
    ...
    histograms.append(f_m250t100.Get('Truth/signal_muon/pt/m_truth_%s' % parameters[p]))
    histograms.append(f_m250t250.Get('Truth/signal_muon/pt/m_truth_%s' % parameters[p]))
    histograms.append(f_m250t500.Get('Truth/signal_muon/pt/m_truth_%s' % parameters[p]))
    histograms.append(f_m500t100.Get('Truth/signal_muon/pt/m_truth_%s' % parameters[p]))
    histograms.append(f_m500t250.Get('Truth/signal_muon/pt/m_truth_%s' % parameters[p]))
    histograms.append(f_m500t500.Get('Truth/signal_muon/pt/m_truth_%s' % parameters[p]))
    histograms.append(f_m1000t100.Get('Truth/signal_muon/pt/m_truth_%s' % parameters[p]))
    histograms.append(f_m1000t250.Get('Truth/signal_muon/pt/m_truth_%s' % parameters[p]))
    histograms.append(f_m1000t500.Get('Truth/signal_muon/pt/m_truth_%s' % parameters[p]))
