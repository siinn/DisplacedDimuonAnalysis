...
svcMgr.EventSelector.InputCollections=["/afs/cern.ch/user/a/asgbase/patspace/xAODs/r7725/mc15_13TeV.410000.PowhegPythiaEvtGen_P2012_ttbar_hdamp172p5_nonallhad.merge.AOD.e3698_s2608_s2183_r7725_r7676/AOD.07915862._000100.pool.root.1"]   #insert your list of input files here

algseq = CfgMgr.AthSequencer("AthAlgSeq")                #gets the main AthSequencer
algseq += CfgMgr.DisplacedDimuonAnalysisAlg()                                 #adds an instance of your alg to it
...
#xaodStream.AddAcceptAlgs( "DisplacedDimuonAnalysisAlg" ) #will only keep events where 'setFilterPassed(false)' has NOT been called in the given algorithm
