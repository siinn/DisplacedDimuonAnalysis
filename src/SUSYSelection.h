#ifndef DISPLACEDDIMUONANALYSIS_SUSYSELECTION_H
#define DISPLACEDDIMUONANALYSIS_SUSYSELECTION_H 1
...
class SUSYSelection: public ::AthAnalysisAlgorithm { 
    public: 
        SUSYSelection( const std::string& name, ISvcLocator* pSvcLocator );
    ...
    private: 
        ...
        // cut flow
        TH1D* m_susy_dv_eff_cutflow; //!

        // efficiency as a function of track parameters
        TEfficiency* m_susy_dv_eff_eta; //! 
        TEfficiency* m_susy_dv_eff_phi; //! 
        TEfficiency* m_susy_dv_eff_mass; //! 
        TEfficiency* m_susy_dv_eff_R; //! 
        TEfficiency* m_susy_dv_eff_z; //! 
        TEfficiency* m_susy_dv_eff_d0; //! 
        
        // efficiency as a function of Z' parameters
        TEfficiency* m_susy_dv_eff_zp_eta; //! 
        TEfficiency* m_susy_dv_eff_zp_beta; //! 
        TEfficiency* m_susy_dv_eff_zp_pt; //! 

        // efficiency as a function of pile-up
        TEfficiency* m_susy_dv_eff_mu; //! 

        // trigger efficiency
        TH1D* m_susy_dv_eff_trig; //! 

        // efficiency map
        TH2F* m_susy_dv_eff_map_pt_eta_num; //! 
        TH2F* m_susy_dv_eff_map_pt_eta_den; //! 
        TH2F* m_susy_dv_eff_map_pt_eta; //! 

        // efficiency map (eta vs mu) for reweighting
        TH2F* m_susy_dv_eff_map_mu_eta_num; //! 
        TH2F* m_susy_dv_eff_map_mu_eta_den; //! 
        TH2F* m_susy_dv_eff_map_mu_eta; //! 
...
#endif //> !DISPLACEDDIMUONANALYSIS_SUSYSELECTION_H
